...
(function () {
  ...
  const PLACE_ALIASES = {
    ...
    TRIPLE: 'Triples', TRIPLES: 'Triples', '3X': 'Triples',
    DOUBLE: 'Doubles', DOUBLES: 'Doubles', '2X': 'Doubles', WAU: 'Doubles',
    OCTO: 'Octos', OCTOS: 'Octos', OCTA: 'Octos', OCTAS: 'Octos', OCTAFINALS: 'Octos', OCTAFINAL: 'Octos', OF: 'Octos', RKR: 'Octos',
    QUARTER: 'Quarters', QUARTERS: 'Quarters', QUARTE: 'Quarters', QUARTERFINALS: 'Quarters', QF: 'Quarters', PB: 'Quarters',
    SEMI: 'Semis', SEMIS: 'Semis', S: 'Semis', SEMIFINALS: 'Semis', SEMIFINAL: 'Semis', SF: 'Semis', MD: 'Semis',
